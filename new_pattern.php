...
if (isset($_POST['create'])) {
    header("Location: board-pattern.php");
        exit;
}
...
<body class="center">
    ...
    <div class="colomn center" id="form-div">
        ...
        <form action="new_pattern.php" method="POST">
            <input type="text" name="title" placeholder="Название шаблона" required>
            <textarea type="text" name="discription" placeholder="Описание к шаблону" id="discription"></textarea>
